# Read CSV file
grades <- read.csv("D:/FCIS Stuff/Materials/Year 4/Y4 S2/Work/Big Data [SWE 487] (4CH)/Project/Admission_Predict_Ver1.1.csv")
...
# Model Accuracy Using Correlation
correlation_accuracy <- cor(actuals_preds) * 100
correlation_accuracy

# Model Accuracy Using Min Max Accuracy
